...
// content
var content = [
  {name: "Anonymous #1793", startRank: "platinum4", endRank: "diamond3", message: "<q>Very efficent booster. Expected that it would take much longer but this guy was a beast.</q>"},
  {name: "Anonymous #932", startRank: "gold2", endRank: "platinum2", message: "<q>Super helpfull and easy to talk people. Had a blast playing and got to where I wanted alot quicker than I imagined. Thanks!</q>"},
  {name: "Anonymous #1143", startRank: "bronze3", endRank: "silver4", message: "<q>Definitly will come back here when I need help again, best booster ever!</q>"},
  ...
  {name: "Anonymous #756", startRank: "silver4", endRank: "platinum4", message: "<q>Quick and easy. No bullshit, just straight into action. Love you guys!</q>"},
  ...
  {name: "Anonymous #1271", startRank: "silver2", endRank: "gold4", message: "<q>Super helpfull and easy to talk people. Had a blast playing and got to where I wanted alot quicker than I imagined. Thanks!</q>"},
  {name: "Anonymous #1089", startRank: "silver2", endRank: "gold4", message: "<q>Super helpfull and easy to talk people. Had a blast playing and got to where I wanted alot quicker than I imagined. Thanks!</q>"},
  {name: "Anonymous #658", startRank: "silver2", endRank: "gold4", message: "<q>I think I am in love!! Marry me please!</q>"},
  {name: "Anonymous #517", startRank: "silver2", endRank: "gold4", message: "<q>Super helpfull and easy to talk people. Had a blast playing and got to where I wanted alot quicker than I imagined. Thanks!</q>"},
  {name: "Anonymous #1820", startRank: "silver2", endRank: "gold4", message: "<q>Super helpfull and easy to talk people. Had a blast playing and got to where I wanted alot quicker than I imagined. Thanks!</q>"},
  {name: "Anonymous #434", startRank: "silver2", endRank: "gold4", message: "<q>Super helpfull and easy to talk people. Had a blast playing and got to where I wanted alot quicker than I imagined. Thanks!</q>"},
];
/*for (var i = 1; i <= 100; i++){
